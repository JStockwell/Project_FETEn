...
func before_test():
	...
	#CombatMapStatus.set .set_enemies(["defender"])
...
func test_calc_hit_chance_true_hit(do_skip=true, skip_reason="Waiting for maintenance"):
...
func test_calc_hit_chance_true_hit_fail(do_skip=true, skip_reason="Waiting for maintenance"):
	var attDex = CombatMapStatus.get_attacker_stats().get("dexterity")
	var defAgi = CombatMapStatus.get_defender_stats().get("agility")
	var rolls = [1, 72, 1, 1]
...
func test_calc_hit_chance_bloated_hit(do_skip=true, skip_reason="Waiting for maintenance"):
	var attDex = CombatMapStatus.get_attacker_stats().get("dexterity")
	var defAgi = CombatMapStatus.get_defender_stats().get("agility")
...
func test_calc_hit_chance_bloated_hit_fail(do_skip=true, skip_reason="Waiting for maintenance"):
	var attDex = CombatMapStatus.get_attacker_stats().get("dexterity")
	var defAgi = CombatMapStatus.get_defender_stats().get("agility")
...
func test_calc_crit(do_skip=true, skip_reason="Waiting for maintenance"):
	var attDex = CombatMapStatus.get_attacker_stats().get("dexterity")
...
func test_calc_crit_no(do_skip=true, skip_reason="Waiting for maintenance"):
	var attDex = CombatMapStatus.get_attacker_stats().get("dexterity")
	var attAgi = CombatMapStatus.get_attacker_stats().get("agility")
	var defAgi = CombatMapStatus.get_defender_stats().get("agility")
	var rolls = [1, 1, 1, 14]
...
func test_calc_damage_no_magic(do_skip=true, skip_reason="Waiting for maintenance"):
...
func test_calc_damage_magic(do_skip=true, skip_reason="Waiting for maintenance"):
...
func test_calc_damage_no_magic_SPA(do_skip=true, skip_reason="Waiting for maintenance"):
...
func test_calc_damage_magic_no_SPA(do_skip=true, skip_reason="Waiting for maintenance"):
...
func test_combat_round_melee(do_skip=true, skip_reason="Waiting for maintenance"):
...
func test_combat_round_ranged(do_skip=true, skip_reason="Waiting for maintenance"):
...
func test_combat_round_skill_no_SEF_no_retaliation(do_skip=true, skip_reason="Waiting for maintenance"):
...
func test_combat_round_skill_SEF_no_retaliation(do_skip=true, skip_reason="Waiting for maintenance"):
	test_combat.combat_round([1, 100, 1, 100], [1, 1, 1, 100], 0, 4,"nero_nero")

	assert_int(defender.get_current_health()).is_less(defender.get_max_health())
	
	
func test_attack_hit(do_skip=true, skip_reason="Waiting for maintenance"):
	var rolls = [1, 1, 1, 1]
...
func test_attack_miss(do_skip=true, skip_reason="Waiting for maintenance"):
	var rolls = [1, 100, 1, 1]
...
func test_deal_damage_positive_no_crit(do_skip=true, skip_reason="Waiting for maintenance"):
...
func test_deal_damage_positive_crit(do_skip=true, skip_reason="Waiting for maintenance"):
...
func test_deal_damage_0(do_skip=true, skip_reason="Waiting for maintenance"):
	test_combat.deal_damage(0, 1., defender)
	
	assert_that(defender.get_current_health()).is_equal(defender.get_max_health())
	assert_that(test_combat.damageNumber.text).is_equal("0")
	
func test_deal_damage_negative(do_skip=true, skip_reason="Waiting for maintenance"):
