...
func _ready():
	Player.set_stats(GameStatus_v3.activePlayer)
	Enemy.set_stats(GameStatus_v3.activeEnemy)
	
	setStatsLabel(playerStatsLabel, GameStatus_v3.activePlayer)
	setStatsLabel(enemyStatsLabel, GameStatus_v3.activeEnemy)
